...
<div class="form-group">
	...
	<select name='status' class='form-control'>
		<option value="Aktif" <?php if($pelanggan->status_anggota == 'Aktif') { echo 'selected'; } ?>>Aktif</option>
		<option value="Non Aktif" <?php if($pelanggan->status_anggota == 'Non Aktif') { echo 'selected'; } ?>>Non Aktif</option>
	</select>
</div>	
