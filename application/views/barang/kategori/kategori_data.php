...
<div class="container bg-light">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<h3><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i> List Kategori</h3>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('barang/tambah-kategori')."' class='btn btn-primary' id='TambahKategori'><i class='fa fa-plus fa-fw'></i> Tambah Kategori</a>";
...
<script type="text/javascript" language="javascript" >
	...
	$(document).on('click', '#HapusKategori', function(e){
		...
		$('#ModalFooter').html("<button type='button' class='btn btn-primary' id='YesDeleteKategori' data-url='"+Link+"' onClick='window.location.reload();'>Ya, saya yakin</button><button type='button' class='btn btn-default' data-dismiss='modal'>Batal</button>");
		$('#ModalGue').modal('show');
	});
